    ...
    <main className="site-shell">
      ...
      <section className="section compare-section" id="pricing">
        ...
        <div className="role-pricing">
          <article className="pricing-card glass"><div><span>FOUNDER PREMIUM</span><h3><sup>₹</sup>240<small>/ month</small></h3><p>For founders actively raising and building relationships.</p></div><ul><li>Unlimited profile opens</li><li>Unlimited connection requests</li><li>Up to 5 active ideas & niches</li><li>Send messages to connections</li><li>Receipt after mock checkout</li></ul><Link href="/join?role=founder" className="button">Join as Founder</Link></article>
          <article className="pricing-card glass featured"><div className="premium-badge">✦ MOST FOCUSED</div><div><span>INVESTOR PREMIUM</span><h3><sup>₹</sup>310<small>/ month</small></h3><p>For investors building an active opportunity pipeline.</p></div><ul><li>Unlimited profile opens</li><li>Unlimited connection requests</li><li>Up to 5 active niches</li><li>Send messages to connections</li><li>Receipt after mock checkout</li></ul><Link href="/join?role=investor" className="button">Join as Investor</Link></article>
        </div>
